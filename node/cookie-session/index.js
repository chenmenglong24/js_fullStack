...
//   ctx.cookies.set('fromserver1', 'fromserver1', { maxAge: 5000 });
//   ctx.cookies.set('user', 'user', { path: '/user', httpOnly:false })
//   ctx.cookies.set('user-abc', 'user-abc', { path: '/user/abc' })
//   ctx.cookies.set('post', 'post', { path: '/post' })
//   ctx.type = 'html';
//   ctx.body = `
//     <a href="/user"> -> user</a>
//     <a href="/post"> -> post</a>
