...
let local = 'jiangxi/qingshanhu-district';
...
function sendEmail(htmlData){
  const template = ejs.compile(
    fs.readFileSync(
      path.resolve(__dirname, 'email.ejs'), 'utf8'
    )
  )
  ...
  let transporter = nodemailer.createTransport({
    ...
    auth: {
      user: '2268234936@qq.com',
      pass: 'tpwaphqyqbigebgg'
    }
  })
  transporter.sendMail(
    {
      from: '及你太没 <2268234936@qq.com>',
      to: '2268234936@qq.com',
      subject: '邮件',
      html: html
    },
    (err, info) => {
