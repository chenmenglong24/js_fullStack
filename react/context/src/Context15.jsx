  ...
  render() { 
    ...
    return (  
      <div>
        ...
        {/* <button onClick={() => {this.handleToggleTheme('purple')}} data-theme="purple">purple</button>
        <button onClick={() => {this.handleToggleTheme('yellowgreen')}} data-theme="yellowgreen">yellowgreen</button> */}
        <button onClick={this.handleToggleTheme.bind(this, 'purple')} data-theme="purple">purple</button>
        <button onClick={this.handleToggleTheme.bind(this, 'yellowgreen')} data-theme="yellowgreen">yellowgreen</button>
      </div>
    );
  }
}
