<template>
  <div class="map">
    ...
    <!-- 定位按钮 -->
    <div id="buttomDom" @click="locationOnClick"></div>
    <div class="map-start" @click="startGoOnclick" style="z-index:100000">{{startBtn}}</div>
    <!-- 地址 -->
...
export default {
  ...
  methods: {
    ...
    creatTrip () {
      Toast.loading('加载中')
      let that = this
      let buttomDom = document.getElementById('buttonDom')
